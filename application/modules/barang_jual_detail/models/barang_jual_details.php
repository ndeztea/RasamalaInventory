...
class barang_jual_details extends CI_Model 
{
    ...
    /**
     *  Get All data barang_jual_detail
     *
     *  @param limit  : Integer
    ...
    public function get_all($limit, $offset) 
    {
        ...
        $result = $this->db->get('barang_jual_detail', $limit, $offset);
    ...
    {
        $this->db->from('barang_jual_detail');
        return $this->db->count_all_results();
    }
    

    /**
    * Search All barang_jual_detail
    *
    *  @param limit   : Integer
    *  @param offset  : Integer
    *  @param keyword : mixed
    ...
    */
    public function get_search($limit, $offset) 
    {
        ...
        $result = $this->db->get('barang_jual_detail');
    ...
    */
    ...
    /**
    *  Default form data barang_jual_detail
    *  @return array
    *
    */
    public function add()
    ...
    */
    public function update($id)
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('barang_jual_detail', $data);
    }
