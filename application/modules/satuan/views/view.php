...
<section class="panel panel-default">
    <header class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-9">
                 ...
                 <?php echo form_open(site_url('satuan/search'), 'role="search" class="form"') ;?>       
    ...
    <div class="panel-body">
         <?php if ($satuans) : ?>
              ...
              <tr>
               ...
               <td><?php echo $satuan['satuan']; ?></td>
                ...
                <td>    
                    ...
                    <?php
                                  echo anchor(
                                          site_url('satuan/show/' . $satuan['id']),
                   ...
                   ?>
                    ...
                    <?php
                                  echo anchor(
                                          site_url('satuan/edit/' . $satuan['id']),
                   ...
                   <?php
                                  echo anchor(
                                          site_url('satuan/destroy/' . $satuan['id']),
          ...
          <?php else: ?>
                <?php  echo notify('Data satuan belum tersedia','info');?>
          <?php endif; ?>
    </div>
