...
<section class="panel panel-default">
    <header class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-9">
                 ...
                 <?php echo form_open(site_url('status/search'), 'role="search" class="form"') ;?>       
    ...
    <div class="panel-body">
         <?php if ($statuss) : ?>
              ...
              <tr>
               ...
               <td><?php echo $status['status']; ?></td>
                ...
                <td>    
                    ...
                    <?php
                                  echo anchor(
                                          site_url('status/show/' . $status['id']),
                   ...
                   ?>
                    ...
                    <?php
                                  echo anchor(
                                          site_url('status/edit/' . $status['id']),
                   ...
                   <?php
                                  echo anchor(
                                          site_url('status/destroy/' . $status['id']),
          ...
          <?php else: ?>
                <?php  echo notify('Data status belum tersedia','info');?>
          <?php endif; ?>
    </div>
