...
<section class="panel panel-default">
    <header class="panel-heading">
        <div class="row">
            <div class="col-md-8 col-xs-3">                
                <?php
                                  echo anchor(
                                           site_url('barang_beli_detail/add'),
            ...
            <div class="col-md-4 col-xs-9">
                 ...
                 <?php echo form_open(site_url('barang_beli_detail/search'), 'role="search" class="form"') ;?>       
    ...
    <div class="panel-body">
         <?php if ($barang_beli_details) : ?>
          <table class="table table-hover table-condensed">
            ...
            <tbody>
              ...
              <tr>
               ...
               <td><?php echo $barang_beli_detail['id_barang_jual']; ?></td>
               ...
               <td><?php echo $barang_beli_detail['harga']; ?></td>
               
               <td><?php echo $barang_beli_detail['total_harga']; ?></td>
               
                <td>    
                    
                    <?php
                                  echo anchor(
                                          site_url('barang_beli_detail/show/' . $barang_beli_detail['id']),
                   ...
                   ?>
                    ...
                    <?php
                                  echo anchor(
                                          site_url('barang_beli_detail/edit/' . $barang_beli_detail['id']),
                   ...
                   <?php
                                  echo anchor(
                                          site_url('barang_beli_detail/destroy/' . $barang_beli_detail['id']),
          ...
          <?php else: ?>
                <?php  echo notify('Data barang_beli_detail belum tersedia','info');?>
          <?php endif; ?>
    </div>
