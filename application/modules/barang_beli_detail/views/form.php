...
<?php echo form_open(site_url('barang_beli_detail/' . $action),'role="form" class="form-horizontal" id="form_barang_beli_detail" parsley-validate'); ?>               
                ...
                <div class="col-sm-6">                                   
                  <?php                  
                   echo form_dropdown(
                           'id_barang_jual',
                           $id_barang_jual,  
                           set_value('id_barang_jual',$barang_beli_detail['id_barang_jual']),
                  ...
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('nama_barang',$barang_beli_detail['nama_barang'])
                           );             
                  ?>
                  ...
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('kode_barang',$barang_beli_detail['kode_barang'])
                           );             
                  ?>
                  ...
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('jumlah',$barang_beli_detail['jumlah'])
                           );             
                  ?>
                  ...
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('id_satuan',$barang_beli_detail['id_satuan'])
                           );             
                  ?>
                  ...
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('harga',$barang_beli_detail['harga'])
                           );             
                  ?>
                  ...
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('total_harga',$barang_beli_detail['total_harga'])
                           );             
                  ?>
    ...
    <div class="panel-footer">   
          <div class="row"> 
              <div class="col-md-10 col-sm-12 col-md-offset-2 col-sm-offset-0">
                   <a href="<?php echo site_url('barang_beli_detail'); ?>" class="btn btn-default">
