    ...
    <header class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-9">
                 ...
                 <?php echo form_open(site_url('users_akses/search'), 'role="search" class="form"') ;?>       
         ...
         <?php if ($users_aksess) : ?>
          <table class="table table-hover table-condensed">
            ...
            <tbody>
               ...
               <?php foreach ($users_aksess as $users_akses) : ?>
              <tr>
              	<td><?php echo $number++;; ?> </td>
               
               <td><?php echo $users_akses['akses']; ?></td>
               
                <td>    
                    
                    <?php
                                  echo anchor(
                                          site_url('users_akses/show/' . $users_akses['id']),
                   ...
                   ?>
                    ...
                    <?php
                                  echo anchor(
                                          site_url('users_akses/edit/' . $users_akses['id']),
                   ...
                   <?php
                                  echo anchor(
                                          site_url('users_akses/destroy/' . $users_akses['id']),
          ...
          <?php else: ?>
                <?php  echo notify('Data users_akses belum tersedia','info');?>
          <?php endif; ?>
    </div>
